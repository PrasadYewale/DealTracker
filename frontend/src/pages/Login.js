        ...
        <div className="relative bg-zinc-900/90 backdrop-blur-2xl rounded-3xl shadow-2xl border border-lime-500/20 overflow-hidden">
          ...
          <div className="p-8">
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-zinc-400 font-medium tracking-wide">ACCESS YOUR DIGITAL REALM</p>
            </div>
            ...
            <div className="space-y-5">
              ...
              <div className="flex items-center justify-between text-xs pt-2">
                <label className="flex items-center text-zinc-400 cursor-pointer group">
                  <input
                    type="checkbox"
                    className="w-4 h-4 rounded border-2 border-zinc-700 bg-black checked:bg-lime-500 checked:border-lime-500 focus:ring-2 focus:ring-lime-500/20 mr-2"
                  />
                  <span className="group-hover:text-lime-400 transition-colors">Remember me</span>
                </label>
                <button className="text-zinc-400 hover:text-lime-400 transition-colors font-medium">
                  Forgot password?
                </button>
              </div>
