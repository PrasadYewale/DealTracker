# crawler_service/crawlers/flipkart.py
import requests
...
def search_flipkart(query):
    ...
    for item in soup.select("div._1AtVbE"):
        name_tag = item.select_one("div._4rR01T")
        price_tag = item.select_one("div._30jeq3._1_WHN1")
        old_price_tag = item.select_one("div._3I9_wc")
        ...
        if name_tag and price_tag:
            ...
            image_tag = item.select_one("img._396cs4")
